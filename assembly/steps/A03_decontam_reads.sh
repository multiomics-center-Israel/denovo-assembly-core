#!/usr/bin/env bash
# A03_decontam_reads — frozen assembly step. Frozen assembly record/verifier (logic in legacy pipeline.py).
export PIPE_DOMAIN="assembly"; STEP_ID="A03_decontam_reads"
